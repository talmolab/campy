...
def DefaultParams():
    ...
    params["quality"] = 21
    params["preset"] = "None"
    params["videoSegmentLengthInSec"] = 0
...
def ParseClargs(parser):
    parser.add_argument(
        "config",
        metavar="config",
        help="Campy configuration .yaml file.",
    )
    ...
    parser.add_argument(
        "--videoSegmentLengthInSec",
        dest="videoSegmentLengthInSec",
        type=int,
        help="Length of video segments to break long videos up into. If 0, no segmenting is applied.",
    )
